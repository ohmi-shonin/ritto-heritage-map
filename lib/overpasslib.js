"use strict";
// OverPass Server Control(With easy cache) - Updated for Ritto City geographic filtering v2
class OverPassControl {
	...
	getGeojson(targets, progress) {
		return new Promise((resolve, reject) => {
			console.log("overPassCont: Check: Ritto City fixed area")
			if (overPassCont.LLc["ritto_city_cache"] !== void 0 || Conf.static.mode) {
				...
				$.ajax({
					...
					overPassCont.LLc["ritto_city_cache"] = true
