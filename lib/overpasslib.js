...
class OverPassControl {
	...
	getGeojson(targets, progress) {
		return new Promise((resolve, reject) => {
			console.log("overPassCont: Check: Ritto City area filtering")
			if (overPassCont.LLc["ritto_city_area_v1"] !== void 0 || Conf.static.mode) {
				...
				$.ajax({
					...
					overPassCont.LLc["ritto_city_area_v1"] = true
